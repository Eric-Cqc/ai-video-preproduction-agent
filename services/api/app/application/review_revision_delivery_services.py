...
class ReviewRevisionDeliveryApplicationService:
        ...
        *,
        ...
        with self.uow_factory() as uow:
            ...
            try:
                ...
                result = RevisionResult(completed, successors[0], successors[1], successors[2], False)
    ...
    def _reserve_revision_completion(
        ...
        with self.uow_factory() as uow:
            ...
            if existing is not None:
                ...
                reservation = uow.delivery_operations.reserve(candidate)
    ...
    def _generate_revision_contents(
        ...
        return _RevisionContents(script_content, storyboard_content, shot_content), _provider_usage(outcomes)
